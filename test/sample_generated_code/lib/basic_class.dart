...
class ClassJson {
  ...
  ClassJson._fromJsonMapImpl(Map jsonMap)
      : _mString = jsonMap["mString"],
        ...
        // mList is List
        _mList = ebisu.constructListFromJsonData<dynamic>(
            jsonMap["mList"], (data) => data),
        // mMap is Map
        _mMap = ebisu.constructMapFromJsonData<String, dynamic>(
            jsonMap["mMap"], (value) => value),
        _mEnum = Color.fromJson(jsonMap["mEnum"]),
        // mColorMap is Map<Color,String>
        _mColorMap = ebisu.constructMapFromJsonData<Color, String>(
            jsonMap["mColorMap"],
            (value) => value,
